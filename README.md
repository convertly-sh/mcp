...
```bash
CONVERTLY_API_KEY=cvly_your_api_key CONVERTLY_MCP_HTTP_PORT=3000 npx @convertly-sh/mcp
```
...
- `save_cloud_file` — download a cloud file directly to an approved local folder
